...
plot(PowerSubset$DateTime, PowerSubset$Voltage, ylab="Voltage", xlab="datetime", type="l")
...
plot(PowerSubset$DateTime, PowerSubset$Global_reactive_power, ylab="Global_reactive_power", xlab="datetime", type="l")
